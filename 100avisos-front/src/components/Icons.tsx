...
export const TypesIcon = (props: IconProps) => (
  <svg {...baseProps} {...props}>
    <path
...
export const ResourcesIcon = (props: IconProps) => (
  <svg {...baseProps} {...props}>
    <path
      d="M4 7C4 5.89543 4.89543 5 6 5H9L11 7H18C19.1046 7 20 7.89543 20 9V17C20 18.1046 19.1046 19 18 19H6C4.89543 19 4 18.1046 4 17V7Z"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
      strokeLinejoin="round"
